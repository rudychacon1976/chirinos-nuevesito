<?php
  ...
  $sql = "INSERT INTO jefe_familia(nombres, apellidos) VALUES ('$nombres','$apellidos','$cedula','$nombre_genero','$cedula','$serial_carnet',
  '$numero_celular','$numero_telefono','$fecha_nacimiento','$correo','$estado_civil','$grado_instruccion','$sector_trabajo','$ocupacion','$pensionado',
  '$discapacitado','$incapacitado','$codigo_carnet','$serial_carnet','$cne','$actividad_comercial','$tipo_actividad','$cargas_familiares')";

  $sql1 = "INSERT INTO cargas_familiares(nombre_carga, apellido_carga, id_genero, cedula_carga, fecha_nacimiento_carga, discapacitada_carga, incapacitado_carga, embarazo_temprano_carga, id_parentesco, id_grado_instruccion, profesion_carga, ingreso_mensual_carga, inscrito_cne, pensionado_carga, carga_carnet, codigo_carga_carnet, serial_carga_carnet) VALUES
  ('$nombre_carga','$apellido_carga','$genero','$cedula_carga','$fecha_nacimiento_carga','$discapacitada_carga','$incapacitado_carga','$embarazo_temprano_carga', '$id_parentesco', '$id_grado_instruccion', '$profesion_carga', '$ingreso_mensual_carga', '$inscrito_cne', '$pensionado_carga', '$carga_carnet', '$codigo_carga_carnet', '$serial_carga_carnet')";

  $sql2 = "INSERT INTO vivienda() VALUES () ";
